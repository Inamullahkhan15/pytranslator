...
async def translate_text(): # asynchronous function means it can run in the background
    ...
    async with Translator() as translator: # with means it will automatically close the translator when done
        ...
        result = await translator.translate('Man gets what he strives for!', dest='FR') # await means it will wait for the result
